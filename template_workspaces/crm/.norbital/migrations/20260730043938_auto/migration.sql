...
--> statement-breakpoint
SELECT _norbital_create_history_table('customer_prices'::regclass, 'customer_prices_history');
--> statement-breakpoint
...
--> statement-breakpoint
SELECT _norbital_create_history_table('payment_records'::regclass, 'payment_records_history');
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "customer_prices_account_id_product_id_index" ON "customer_prices" ("account_id","product_id");
--> statement-breakpoint
CREATE INDEX "customer_prices_account_id_index" ON "customer_prices" ("account_id");
--> statement-breakpoint
CREATE INDEX "customer_prices_product_id_index" ON "customer_prices" ("product_id");
--> statement-breakpoint
CREATE INDEX "customer_prices_currency_search_trgm_idx" ON "customer_prices" USING gin ("currency" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "payment_records_quote_id_index" ON "payment_records" ("quote_id");
--> statement-breakpoint
CREATE INDEX "payment_records_payment_date_index" ON "payment_records" ("payment_date");
--> statement-breakpoint
CREATE INDEX "payment_records_method_search_trgm_idx" ON "payment_records" USING gin ("method" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "payment_records_reference_search_trgm_idx" ON "payment_records" USING gin ("reference" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "payment_records_notes_search_trgm_idx" ON "payment_records" USING gin ("notes" gin_trgm_ops);
--> statement-breakpoint
CREATE UNIQUE INDEX "products_code_index" ON "products" ("code");
--> statement-breakpoint
CREATE INDEX "products_grade_index" ON "products" ("grade");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "products_grade_search_trgm_idx" ON "products" USING gin ("grade" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "products_mfi_search_trgm_idx" ON "products" USING gin ("mfi" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "products_density_search_trgm_idx" ON "products" USING gin ("density" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "products_supplier_search_trgm_idx" ON "products" USING gin ("supplier" gin_trgm_ops);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "projects_name_search_trgm_idx" ON "projects" USING gin ("name" gin_trgm_ops);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "quotes_project_id_index" ON "quotes" ("project_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "customer_prices" ADD CONSTRAINT "customer_prices_account_id_accounts_fk" FOREIGN KEY ("account_id") REFERENCES "accounts"("norbital_id");
--> statement-breakpoint
ALTER TABLE "customer_prices" ADD CONSTRAINT "customer_prices_product_id_products_fk" FOREIGN KEY ("product_id") REFERENCES "products"("norbital_id");
--> statement-breakpoint
ALTER TABLE "payment_records" ADD CONSTRAINT "payment_records_quote_id_quotes_fk" FOREIGN KEY ("quote_id") REFERENCES "quotes"("norbital_id");
--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_account_id_accounts_fk" FOREIGN KEY ("account_id") REFERENCES "accounts"("norbital_id");
--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_owner_id_user_fk" FOREIGN KEY ("owner_id") REFERENCES "user"("norbital_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "quotes" ADD CONSTRAINT "quotes_project_id_projects_fk" FOREIGN KEY ("project_id") REFERENCES "projects"("norbital_id");
--> statement-breakpoint
