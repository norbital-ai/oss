...
| Structured domain values (money, bank account, work pattern, statutory regime, accrual keys, eligibility rules, payroll snapshots) | `src/datatypes/<name>/` (+definition.ts + +renderer.svelte) | hr-payroll (money, bank_account, work_pattern, …) |
...
| Capability                                                                                                              | Where it lives                             | Precedent                                               |
| ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------- |
| Envoy chat agents for external, accountless users (WhatsApp), scoped to their own records                               | `src/envoys/+<name>.ts`                    | field-operations contractor WhatsApp                    |
