...
| Permission grants per team, write-then-lock approvals, approval routing, audit of who approved                     | `src/policies/+<name>.policy.ts` | field-operations contractor/controller/WhatsApp policies, hr-payroll |
