...
| Permission grants per team, prepare-and-gate approvals, approval routing, audit of who approved                                                    | `src/access/policies/+<name>.ts` + `src/access/+teams.ts`                                   | field-operations contractor/controller/WhatsApp policies, hr-payroll |
