...
The error-channel rules are one law at three depths. SWALLOW2 fires only on an _empty_ recovered
...
The repair is to render the generated object's own state.
