...
const pgliteProbes = new URL('./sync-sync-engine-pglite-probes.test.mjs', import.meta.url);
const prefixModelProbes = new URL('./sync-sync-engine-prefix-model.test.mjs', import.meta.url);

const receipts = [
	{
		url: pgliteProbes,
		hash: '3bd0524d113ac073865fd6070440ccb21408ae393b1103bcd1720a323bacd47f',
		cases: 15
	},
	{
