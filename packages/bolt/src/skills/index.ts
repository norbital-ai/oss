/**
 * The skills Bolt ships, for hosts that want to offer them alongside their own tooling.
 *
 * Exported as data rather than as a tool, because a host already has a tool surface of its own and
 * how it presents documentation is its decision. What Bolt owns is the content and the format;
 * Colony wraps this in a host tool, the standalone runner does not have to.
 *
