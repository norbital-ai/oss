...
- 39edc50: Give `ReadonlyMarkdown` a reading scale, so chat output stops being typeset as a document.
  ...
  written and wrong everywhere markdown arrives _inside_ the UI — a model writing `## Cause` in a chat
