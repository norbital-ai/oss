...
<Stack gap="sm" class="rounded-xl border bg-muted/20 px-5 py-8 text-center sm:px-8">
	<div
		class="mx-auto flex size-10 items-center justify-center rounded-full border bg-background shadow-xs"
	>
