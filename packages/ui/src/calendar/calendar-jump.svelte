...
<Inline gap="xs" {...rest}>
	<select
		class="h-7 rounded-md border border-input bg-background px-1 text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
		aria-label="Month"
		value={shown.month}
