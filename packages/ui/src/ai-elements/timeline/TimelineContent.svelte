<script lang="ts">
	...
	import { SCROLL_AXIS_CLASSES, Stack } from '#lib/layout';
...
<CollapsibleContent
	class={cn(
		...
		scrollable && [
			'data-[state=open]:max-h-[min(20rem,45vh)] data-[state=open]:rounded-md data-[state=open]:border data-[state=open]:border-border/30 data-[state=open]:px-2 data-[state=open]:py-1.5',
