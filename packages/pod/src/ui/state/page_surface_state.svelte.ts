...
} from '$lib/ui/state/platform_state.svelte.js';
import {
	DetailSurfaceService,
	type DetailSurfaceServiceOptions
} from '$lib/ui/subservices/detail_surface.service.js';
import type { TDynamicApplicationScopeData } from '$lib/ui/state/types.js';
