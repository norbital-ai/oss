...
export const AGENT_COMPOSER_EDITOR_CLASS =
	'max-h-40 min-h-14 flex-1 overflow-y-auto resize-none border-0 bg-transparent p-0 text-sm leading-relaxed shadow-none ring-0 focus-within:border-0 focus-within:ring-0 focus-within:ring-offset-0';
