...
export function pod(options: PodPluginOptions = {}): PluginOption[] {
	...
	import { handlePodHostCommand, handlePodRequest, registerPodWorkspace, registerPodDatabaseNotifications, registerPodHostPlugins, getTenantManifest } from ${JSON.stringify(podBuildFile('runtime/server.js'))};
