...
- 1a9060f: Reload the workspace document after changing the active organization so Core serves the selected
...
- 1a9060f: Remove the sync engine's remaining compatibility paths and the gaps they were hiding.
