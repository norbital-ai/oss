...
import { localFileStorage } from '../../src/lib/host/file-storage.js';
import { googleMaps } from '../../src/lib/host/maps.js';
 ...
 * Inside a hosted isolate the same binding is the proxy in `runtime/serve.ts`, whose `get` trap
...
describe('facility bindings across the isolate boundary', () => {
	 ...
	 */
	it('validates notification channels when messaging is reached through the serve.ts proxy', async () => {
