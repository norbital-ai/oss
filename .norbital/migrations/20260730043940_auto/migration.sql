...
SELECT _norbital_create_history_table('accrual_bands'::regclass, 'accrual_bands_history');
--> statement-breakpoint
...
--> statement-breakpoint
SELECT _norbital_create_history_table('component_types'::regclass, 'component_types_history');
--> statement-breakpoint
...
--> statement-breakpoint
SELECT _norbital_create_history_table('contribution_treatments'::regclass, 'contribution_treatments_history');
--> statement-breakpoint
...
--> statement-breakpoint
SELECT _norbital_create_history_table('leave_ledger'::regclass, 'leave_ledger_history');
--> statement-breakpoint
...
--> statement-breakpoint
SELECT _norbital_create_history_table('payslip_contributions'::regclass, 'payslip_contributions_history');
--> statement-breakpoint
...
--> statement-breakpoint
SELECT _norbital_create_history_table('payslip_line_sources'::regclass, 'payslip_line_sources_history');
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "accrual_bands_leave_code_search_trgm_idx" ON "accrual_bands" USING gin ("leave_code" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "accrual_bands_authority_search_trgm_idx" ON "accrual_bands" USING gin ("authority" gin_trgm_ops);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "component_types_code_index" ON "component_types" ("code");
--> statement-breakpoint
CREATE INDEX "component_types_code_search_trgm_idx" ON "component_types" USING gin ("code" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "component_types_name_search_trgm_idx" ON "component_types" USING gin ("name" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "component_types_nature_search_trgm_idx" ON "component_types" USING gin ("nature" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "component_types_description_search_trgm_idx" ON "component_types" USING gin ("description" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "contribution_treatments_authority_search_trgm_idx" ON "contribution_treatments" USING gin ("authority" gin_trgm_ops);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "leave_ledger_employment_id_leave_type_id_entry_date_index" ON "leave_ledger" ("employment_id","leave_type_id","entry_date");
--> statement-breakpoint
CREATE INDEX "leave_ledger_kind_search_trgm_idx" ON "leave_ledger" USING gin ("kind" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "leave_ledger_note_search_trgm_idx" ON "leave_ledger" USING gin ("note" gin_trgm_ops);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "payslip_contributions_payslip_id_index" ON "payslip_contributions" ("payslip_id");
--> statement-breakpoint
CREATE INDEX "payslip_contributions_band_reference_search_trgm_idx" ON "payslip_contributions" USING gin ("band_reference" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "payslip_line_sources_payslip_line_id_index" ON "payslip_line_sources" ("payslip_line_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "agent_run_step_kind_search_trgm_idx" ON "agent_run_step" USING gin ("kind" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "agent_run_step_role_search_trgm_idx" ON "agent_run_step" USING gin ("role" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "agent_run_step_content_search_trgm_idx" ON "agent_run_step" USING gin ("content" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "agent_run_step_tool_call_id_search_trgm_idx" ON "agent_run_step" USING gin ("tool_call_id" gin_trgm_ops);
--> statement-breakpoint
CREATE INDEX "agent_run_step_tool_name_search_trgm_idx" ON "agent_run_step" USING gin ("tool_name" gin_trgm_ops);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "contribution_treatments" ADD CONSTRAINT "contribution_treatments_component_type_id_component_types_fk" FOREIGN KEY ("component_type_id") REFERENCES "component_types"("norbital_id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "contribution_treatments" ADD CONSTRAINT "contribution_treatments_statutory_contribution_id_statutory_contributions_fk" FOREIGN KEY ("statutory_contribution_id") REFERENCES "statutory_contributions"("norbital_id") ON DELETE CASCADE;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "leave_ledger" ADD CONSTRAINT "leave_ledger_employment_id_employments_fk" FOREIGN KEY ("employment_id") REFERENCES "employments"("norbital_id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "leave_ledger" ADD CONSTRAINT "leave_ledger_leave_type_id_leave_types_fk" FOREIGN KEY ("leave_type_id") REFERENCES "leave_types"("norbital_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "pay_components" ADD CONSTRAINT "pay_components_component_type_id_component_types_fk" FOREIGN KEY ("component_type_id") REFERENCES "component_types"("norbital_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "payslip_contributions" ADD CONSTRAINT "payslip_contributions_payslip_id_payslips_fk" FOREIGN KEY ("payslip_id") REFERENCES "payslips"("norbital_id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "payslip_contributions" ADD CONSTRAINT "payslip_contributions_statutory_contribution_id_statutory_contributions_fk" FOREIGN KEY ("statutory_contribution_id") REFERENCES "statutory_contributions"("norbital_id");
--> statement-breakpoint
ALTER TABLE "payslip_line_sources" ADD CONSTRAINT "payslip_line_sources_payslip_line_id_payslip_lines_fk" FOREIGN KEY ("payslip_line_id") REFERENCES "payslip_lines"("norbital_id") ON DELETE CASCADE;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "payslip_lines" ADD CONSTRAINT "payslip_lines_component_type_id_component_types_fk" FOREIGN KEY ("component_type_id") REFERENCES "component_types"("norbital_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "agent_run_step" ADD CONSTRAINT "agent_run_step_owner_user_id_user_norbital_id_fkey" FOREIGN KEY ("owner_user_id") REFERENCES "user"("norbital_id");
--> statement-breakpoint
ALTER TABLE "agent_run_step" ADD CONSTRAINT "agent_run_step_774UFu3iuSmm_fkey" FOREIGN KEY ("automation_run_id") REFERENCES "automation_run"("norbital_id");
--> statement-breakpoint
